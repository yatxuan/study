package cn.yat.modules.common.id;
...
public class IdWorker {
    ...
    public synchronized long nextId() {
        ...
        return ((timestamp - TWELFTH) << TIMESTAMP_LEFT_SHIFT)
    ...
    public static void main(String[] args) {
        ...
        //耗时
        long timeConsNum = (System.currentTimeMillis() - beginTime);

        System.out.println("consNum time:" + timeConsNum + "毫秒");
        System.out.println("consNum time:" + timeConsNum / 1000 + "秒");
    }
}
