...
public class AuthFilter extends AuthenticatingFilter {
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        this.token = shiroService.getToken(httpRequest);
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(token)) {
            ...
            String json = new Gson().toJson(new ResponseEntity<>("invalid token", HttpStatus.UNAUTHORIZED));
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            String json = new Gson().toJson(new ResponseEntity<>(throwable.getMessage(), HttpStatus.UNAUTHORIZED));
            httpResponse.getWriter().print(json);
